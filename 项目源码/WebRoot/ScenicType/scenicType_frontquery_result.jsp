		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#scenicTypeListPanel" aria-controls="scenicTypeListPanel" role="tab" data-toggle="tab">景点类型列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ScenicType/scenicType_frontAdd.jsp" style="display:none;">添加景点类型</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<scenicTypeList.size();i++) {
					    	            		...
					    	            		ScenicType scenicType = scenicTypeList.get(i); //获取到景点类型对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;景点类型信息编辑</h4>
      </div>
