		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>ScenicType/frontlist">景点类型列表</a></li>
			    	<li role="presentation" class="active"><a href="#scenicTypeAdd" aria-controls="scenicTypeAdd" role="tab" data-toggle="tab">添加景点类型</a></li>
				</ul>
				<!-- Tab panes -->
